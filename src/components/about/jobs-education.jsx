    ...
    const jobs = [
        {
            ...
            text: 'Cумський Державний Університет'
        },
        {
            year: '2005-2019',
            icon: '/images/jobs/psycho2005.svg',
            title: 'Спеціалізація з психіатрії, наркології, психотерапії',
        ...
        },
        {
            ...
            title: 'Наркологія',
            text: 'Захистив дисертацію на здобуття наукового ступеню – кандидата медичних наук за спеціальністю. Маю 25 наукових праць, з яких 5 – у спеціалізованих професійних виданнях, затверджених ДАК МОН України (всі одноосібні), 4 впровадження'
        }
    ];
    ...
    const education = [
        {
            ...
            text: 'КНП СОР «Обласний клінічний медичний центр соціально небезпечних захворювань». Відділення інтенсивної терапії та детоксикації, лікар нарколог, 18 років досвіду роботи'
        },
        {
            icon: '/images/education/private-practice.svg',
            title: 'Приватна медична практика з наркології',
            text: 'ФОП «Гегешко В.В.». Приватна медична практика з наркології'
        }
    ]
